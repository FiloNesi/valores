...
// Web interactiva: "Un día en una ciudad vacía"
// Instrucciones rápidas:
// 1) Pulsa "Comenzar" para leer la situación detonante.
// 2) En cada pantalla elige una de las 3 opciones. El recorrido tiene 3 decisiones.
// 3) Al final, verás preguntas de reflexión y podrás copiar tus respuestas.

export default function CiudadVaciaInteractive() {
  ...
  const nodes = useMemo(() => ({
    ...
    L1_comida: {
      ...
      options: [
        {
          id: "L2_racionar",
          label: "Racionar víveres y organizar una despensa básica",
        },
        {
          id: "L2_buscaragua",
          label: "Buscar fuentes de agua seguras en la ciudad",
        },
        {
          id: "L2_energia",
          label: "Intentar restablecer energía básica (generador)",
        },
      ],
    },
    ...
    L2_buscaragua: {
      ...
      text: (
        <>
          <p className="mb-2">Localizas una fuente y depósitos. Necesitas potabilizar el agua para evitar enfermedades.</p>
        </>
      ),
      options: [
    ...
    L2_radio: {
      ...
      text: (
        <>
          <p className="mb-2">Emites a horas fijas. El silencio genera incertidumbre, pero establecer rutinas ayuda.</p>
        </>
      ),
      options: [
    ...
    L2_mensajes: {
      ...
      text: (
        <>
          <p className="mb-2">Colocas mensajes en puntos clave. Eliges un lenguaje claro y símbolos entendibles.</p>
        </>
      ),
      options: [
    ...
    L2_refugio: {
      ...
      text: (
        <>
          <p className="mb-2">Preparas un espacio acogedor. Surgen preguntas: ¿quién decide? ¿cómo se reparte lo escaso?</p>
        </>
      ),
      options: [
    ...
    L2_hospital: {
      ...
      text: (
        <>
          <p className="mb-2">Consigues un botiquín y una guía de primeros auxilios. Aprender salva vidas.</p>
        </>
      ),
      options: [
    ...
    L2_estacion: {
      ...
      text: (
        <>
          <p className="mb-2">Revisas rutas, combustibles y transporte. La logística coordina la ciudad.</p>
        </>
      ),
      options: [
    ...
    L2_normas: {
      ...
      text: (
        <>
          <p className="mb-2">Piensas en la convivencia futura. ¿Cómo garantizar justicia y participación?</p>
        </>
      ),
      options: [
    ...
    L3_huerto: endNode("Progreso sostenible", [
      "Has asegurado calorías a medio plazo. ¿Qué conocimientos necesitas compartir para mejorar la cosecha?",
    ]),
    L3_intercambio: endNode("Reglas para el intercambio", [
      "Piensas en precios justos y en evitar abusos. ¿Cómo garantizarías transparencia y acceso equitativo?",
    ]),
    L3_proteccion: endNode("Seguridad alimentaria", [
      "Inventario claro y accesos definidos reducen conflictos. ¿Cómo comunicarías estas reglas?",
    ]),

    L3_hervir: endNode("Potabilización básica", [
      "Reducir riesgos requiere disciplina. ¿Cómo mantendrías el protocolo cuando lleguen más personas?",
    ]),
    L3_quimico: endNode("Recursos sanitarios", [
      "Las farmacias son finitas. ¿Cómo planificar el relevo cuando se agoten los suministros?",
    ]),
    L3_cooperar: endNode("Cooperación abierta", [
      "Dejar instrucciones ayuda a otros. ¿Qué virtudes del diálogo practicarás si aparece más gente?",
    ]),

    L3_comunicacionEnergia: endNode("Energía para comunicar", [
      "Priorizar comunicación puede traer ayuda. ¿Qué normas de uso establecerías para el equipo?",
    ]),
    L3_refrigeracion: endNode("Guardar lo esencial", [
      "Evitas pérdidas, pero consumes energía. ¿Cómo decidirías qué se refrigera primero?",
    ]),
    L3_luzSeguridad: endNode("Iluminar y cuidar", [
      "La seguridad aumenta el descanso. ¿Cómo equilibrar seguridad con ahorro energético?",
    ]),

    L3_protocolo: endNode("Lenguaje claro", [
      "Un protocolo reduce malentendidos. ¿Qué indicadores usarás para evaluar si funciona?",
    ]),
    L3_baliza: endNode("Señales visibles", [
      "Las balizas orientan a cualquiera. ¿Cómo evitarías que la información se manipule?",
    ]),
    L3_registro: endNode("Evidencias y mejora", [
      "Registrar ayuda a aprender. ¿Qué patrones buscarías en los datos?",
    ]),

    L3_mapa: endNode("Mapa inclusivo", [
      "Un mapa guía a recién llegados. ¿Cómo lo mantendrás actualizado?",
    ]),
    L3_idiomas: endNode("Comunicación inclusiva", [
      "Múltiples idiomas e iconos reducen barreras. ¿Qué otras barreras debes prever?",
    ]),
    L3_punto: endNode("Encuentro seguro", [
      "Un punto y horarios evitan pérdidas de tiempo. ¿Qué harás ante desacuerdos?",
    ]),

    L3_normasJustas: endNode("Normas claras", [
      "Las reglas dan estabilidad. ¿Cómo asegurarías que todos participen en su revisión?",
    ]),
    L3_mediacion: endNode("Mediación y paz", [
      "Diseñas un sistema para resolver conflictos. ¿Qué virtudes del diálogo son clave?",
    ]),
    L3_transparencia: endNode("Transparencia", [
      "Publicar decisiones reduce sospechas. ¿Qué información debe ser pública y cuál privada?",
    ]),

    L3_formacion: endNode("Cuidar la vida", [
      "Formarse salva vidas. ¿Cómo organizarías turnos y tutorías para aprender?",
    ]),
    L3_prevencion: endNode("Prevención primero", [
      "La salud depende de hábitos. ¿Qué normas higiénicas consensuarías?",
    ]),
    L3_derivar: endNode("Red de salud", [
      "Señalizar recursos mejora el acceso. ¿Cómo priorizarías casos urgentes?",
    ]),

    L3_rutas: endNode("Rutas seguras", [
      "Definir rutas ahorra tiempo y riesgos. ¿Cómo evaluarías su eficacia?",
    ]),
    L3_almacen: endNode("Reparto equitativo", [
      "Centralizar ayuda a la justicia distributiva. ¿Qué criterio usarías para repartir?",
    ]),
    L3_emergencias: endNode("Prioridades claras", [
      "Un plan salva vidas en crisis. ¿Quién decide y con qué legitimidad?",
    ]),

    L3_constituyentes: endNode("Principios básicos", [
      "Dignidad, igualdad y cooperación como base. ¿Cómo relacionas esto con el art. 1 y 10 de la Constitución de 1978?",
    ]),
    L3_tomasdecisiones: endNode("Decidir juntos", [
      "Voto o consenso: opciones distintas. ¿Cuándo preferirías cada una?",
    ]),
    L3_derechos: endNode("Derechos y deberes", [
      "Equilibrar libertades y responsabilidades evita abusos. ¿Qué derechos mínimos garantizarías?",
    ]),
  }), []);
    ...
    <div className="min-h-screen w-full bg-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl bg-white rounded-2xl shadow-xl p-6 md:p-8">
        <header className="flex items-start justify-between gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold">Un día en una ciudad vacía</h1>
            <p className="text-slate-500">Aventura de 3 decisiones · supervivencia · comunicación · progreso</p>
          </div>
          <div className="text-right">
            <button onClick={restart} className="px-3 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm">Reiniciar</button>
          </div>
        </header>

        {/* Barra de progreso */}
        <div className="mt-4 h-2 w-full bg-slate-200 rounded-full overflow-hidden" aria-label="Progreso">
          <div className="h-full bg-slate-700" style={{ width: `${progress * 100}%` }} />
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-3">
          {node.options.map((opt) => (
            <button
              ...
              className="w-full text-left bg-white border border-slate-200 hover:border-slate-400 rounded-xl p-4 shadow-sm hover:shadow"
            >
              <div className="font-medium">{opt.label}</div>
              <div className="text-xs text-slate-500">Elige para continuar…</div>
            </button>
          ))}
        </div>
      ) : (
...
function Reflection({ copySummary, pathIds, nodes }) {
  return (
    <div className="grid gap-3">
      <h3 className="text-lg font-semibold">Reflexión final</h3>
      ...
      <div className="flex flex-wrap gap-3 mt-2">
        <button onClick={copySummary} className="px-4 py-2 rounded-xl bg-slate-800 text-white hover:bg-slate-900">Copiar mi recorrido</button>
        <details className="px-4 py-2 rounded-xl bg-slate-50 border border-slate-200">
          <summary className="cursor-pointer font-medium">Ver ruta elegida</summary>
          <ol className="list-decimal pl-5 mt-2 text-slate-600">
            {pathIds.map((id, i) => (
              <li key={i}><span className="font-mono text-xs bg-slate-100 px-2 py-0.5 rounded">{id}</span> — <em>{nodes[id]?.title || ""}</em></li>
            ))}
          </ol>
        </details>
      </div>
...
function Tips() {
  return (
    <aside className="grid gap-2 bg-white border border-slate-200 rounded-xl p-4">
      <h4 className="font-semibold">Pistas didácticas</h4>
